...
export const TOOLS: TToolCard[] = [
  ...
  },
  {
    ...
    description: "Convert any image to JPG, PNG, WebP, BMP, or AVIF with batch processing and quality control",
    features: ["10+ formats", "Batch conversion", "Quality control"],
